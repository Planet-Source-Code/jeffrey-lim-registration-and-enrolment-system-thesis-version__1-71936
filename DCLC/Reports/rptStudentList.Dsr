VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptStudentList 
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item3 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   1590
         Object.Height          =   1440
         Picture         =   "rptStudentList.dsx":0000
      EndProperty
      ItemType4       =   3
   ...
   BeginProperty Section3 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   8421504
         Object.Caption         =   "Telefax No.: (02)939-7229"
         Alignment       =   2
      EndProperty
      ItemType3       =   5
   ...
   EndProperty
End
Attribute VB_Name = "rptStudentList"
...
With Me.Sections("secHeader").Controls
    ...
    .Item("lblRoomNo").Caption = ReportInformation.RoomNo
End With

With Me.Sections("secFooter").Controls
    .Item("lblAddress").Caption = SchoolInformation.Address
    .Item("lblTelNo").Caption = "Tel. No.: " & SchoolInformation.TelNo1 & " / " & SchoolInformation.TelNo2
    .Item("lblFaxNo").Caption = "Telefax No.: " & SchoolInformation.FaxNo
End With
End Sub
